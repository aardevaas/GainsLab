...
const PRICE_LABELS = { budget: 'Budget', moderate: 'Moderate', premium: 'Premium' };
...
export default async function SupplementsPage({ searchParams }: Props) {
  ...
  const supplements = filterSupplements(activeGoal as SupplementGoal | null, activeEvidence);
