...
import { ARTICLE_CATEGORIES, type ArticleCategory } from '@/lib/learn/types';
...
export default async function LearnPage({ searchParams }: Props) {
  ...
  let query = supabase
    ...
    .select('slug, title, category, summary, reading_time')
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <span
                    ...
                    style={{
                      background: `${CATEGORY_COLORS[article.category as ArticleCategory]}20`,
                      color: CATEGORY_COLORS[article.category as ArticleCategory],
                    }}
                  >
                    {article.category}
                  </span>
